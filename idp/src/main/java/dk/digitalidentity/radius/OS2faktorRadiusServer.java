...
public class OS2faktorRadiusServer extends RadiusServer {
	...
	public OS2faktorRadiusServer(int authPort, boolean requireMfa, PersonService personService, MFAService mfaService, RadiusConfiguration radiusConfiguration, LoginService loginService, RadiusClientService radiusClientService, AuditLogger auditLogger) {
		super(authPort);
