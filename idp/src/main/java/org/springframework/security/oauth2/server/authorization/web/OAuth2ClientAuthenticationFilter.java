...
// CHANGES: Copied from 7.0.0-M3 and the only changes are added 3 loglines
...
public final class OAuth2ClientAuthenticationFilter extends OncePerRequestFilter {
	...
	private void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		// BSG: I added logging here
		log.warn("OAuth2Error.errorCode = " + error.getErrorCode());
		log.warn("OAuth2Error.description = " + error.getDescription());
		log.warn("OAuth2Error.uri = " + error.getUri());
