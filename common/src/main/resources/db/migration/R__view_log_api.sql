CREATE OR REPLACE VIEW view_audit_log_api AS
  SELECT a.id, a.tts, a.ip_address, a.correlation_id, a.person_id, a.person_name, a.cpr, a.performer_id, a.performer_name, a.log_action, a.message, a.person_domain,
