...
public class TUTermsAndConditionsService {
	...
	public TUTermsAndConditions getTermsAndConditions() {
		List<TUTermsAndConditions> all = termsAndConditionsDao.findAll();
		
		if (all.size() == 0) {
			TUTermsAndConditions termsAndConditions = new TUTermsAndConditions();
			termsAndConditions.setContent("<p>Disse vilkår regulerer tjenesteudbyderes anvendelse af kommunens logintjeneste, og de oplysninger der stilles til rådighed i forbindelse med login.</p>\n"
					+ "\n"
