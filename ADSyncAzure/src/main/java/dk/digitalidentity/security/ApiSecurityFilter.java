...
public class ApiSecurityFilter implements Filter {
	...
	public void setConfiguration(OS2faktorAzureADSyncConfiguration configuration) {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
		...
		if (authHeader != null) {
			...
			if (Objects.equals(configuration.getApiKey(), authHeader)) {
				apiKeyMatch = true;
			}
			...
			unauthorized(response, "Missing ApiKey header", null);
		}
	}
